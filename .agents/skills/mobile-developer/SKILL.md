...
description: >-
  ...
  and .agents/skills/mobile-starter.
---
...
2. Read **`.agents/skills/mobile-starter/SKILL.md`** and its `references/` files for architecture, authentication, testing, and official doc links.
3. Respect **`AGENTS.md`**: do **not** edit `PROJECT_SPEC.md` or `PROJECT_SPEC.html`. After milestones, API contract changes, or intentional architectural deviations, tell the user to invoke **`$spec-maintainer`** to audit and sync the spec.
