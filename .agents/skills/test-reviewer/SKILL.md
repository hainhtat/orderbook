...
2. Read **`.agents/skills/test/SKILL.md`** and follow its principles for focused, high-value testing.
3. Respect **`AGENTS.md`**: do not edit `PROJECT_SPEC.md` or `PROJECT_SPEC.html`. If the spec appears intentionally outdated, tell the requesting agent to invoke **`$spec-maintainer`**.
...
- Read the request or changed area carefully.
