...
description: >-
  ...
  PROJECT_SPEC.md and .cursor/skills/backend-starter.
model: inherit
---
...
2. Read **`.cursor/skills/backend-starter/SKILL.md`** and its `references/` files for architecture, database, authentication, errors/localization, testing, and official doc links.
3. Respect **`.cursorrules`**: do **not** edit `PROJECT_SPEC.md` or `PROJECT_SPEC.html`. After milestones, schema changes, new routes, or intentional architectural deviations, tell the user to invoke **`@spec-maintainer`** to audit and sync the spec.
