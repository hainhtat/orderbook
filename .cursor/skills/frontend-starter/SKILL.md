...
4. **Implement architecture** — Follow [references/architecture.md](references/architecture.md) for folder layout, provider tree, routes, layout, theme, and translations.
